...
```text
โจทย์ให้นำค่าราคามารวมกับค่าบริการและหลังจากนั้นก็รวมกับvat โดยมีข้อแม้ที่ค่าบริการขั้นต่ำที่ 50 บาท และ สูงสุด 1000 บาท

Input:
รับค่าราคาเป็น int

Output:
ค่าบริการคิดจาก 10% ของราคา
vatคิดจาก 7% ของราคารวมค่าบริการ
vatขั้นต่ำคิดจาก 7% ของราคาบวก50บาท
vatขั้นสูงคิดจาก 7% ของราคาบวก1000บาท

ถ้าค่าบริการน้อยกว่าเทท่ากับ 50 บาท ให้พิมพ์ vatขั้นต่ำบวกราคาปกติและบวก50บาท และให้พิมพ์เป็นจำนวนจริงทศนิยม 2 หลัก
ถ้าค่าบริการมากกว่าเท่ากับ 1000 บาท ให้พิมพ์ vatขั้นสูงบวกราคาปกติและบวก1000บาท และให้พิมพ์เป็นจำนวนจริงทศนิยม 2 หลัก
ถ้าค่าบริการมากกว่าเท่ากับ 50 และน้อยกว่าเท่ากับ 1000 ให้พิมพ์ vatปกติบวกราคาปกติบวกค่าบริการ และให้พิมพ์เป็นจำนวนจริงทศนิยม 2 หลัก
```
...
```text
Step1:รับค่าราคา
Step2:ค่าบริการ = นำราคา * (10/100)
Step3:vat = ((ราคา + ค่าบริการ) * 7) / 100
Step4:vatขั้นต่ำ = ((ราคา + 50) * 7) / 100
Step5:vatขั้นสูง = ((ราคา + 1000) * 7) / 100
Step6:ถ้่าหากค่าบริการ <= 50 ให้พิมพ์ f"{(vatขั้นต่ำ + 50 + ราคา):.2f}"
Step7:ถ้่าหากค่าบริการ >= 1000 ให้พิมพ์ f"{(vatขั้นสูง + 1000 + ราคา):.2f}"
Step8:ถ้่าหากค่าบริการ >= 50 และ <=999 ให้พิมพ์ f"{(vat + ราคา + ค่าบริการ):.2f}"
```
...
```text
วิธีสุดท้ายของผมเหมือนกับวิธีแรก
```
...
```text
เพราะจะเหลือแค่ค่าบริการขั้นต่ำกับvat
```
...
```text
ช่วยผมแนะนำวิธีเขียน submission.md
```
