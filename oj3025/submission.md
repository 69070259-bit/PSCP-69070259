...
```text
โจทย์ให้ใส่เดือนและวันและให้บอกฤดูที่ได้

input:
สร้างตัวแปรใส่เลขเดือน
สร้างตัวแปรใส่เลขวัน

output:
ถ้าเลขเดือนตรงกับเลขที่กำหนดจะได้ฤดูที่กำหนด
แต่ถ้าเลขวันมากกว่าเท่ากับ21 และ เป็นเดือนที่หาร 3 ลงตัว จะได้ฤดูถัดไป
```
...
```text
Step1:สร้างตัวแปร "MONTH" เพื่อเก็บเลขเดือน
Step2:สร้างตัวแปร "DAY" เพื่อเก็บเลขวัน
Step3:ถ้า "MONTH" มีค่าอยู่เท่ากับ 1, 2, 3
Step4:และถ้าเดือนนั้น == 3 และ วัน >= 21
Step5:พิมพ์ "Spring"
Step6:ถ้าไม่ใช้ให้พิมพ์ "Winter"
Step7:ทำวิธีเดิมแค่เปลี่ยนค่าไปเลื่อยๆจนครบทั้ง 12 เดือน
```
...
```text
วิธีสุดท้ายเหมือนกับวิธีแรก แค่แก้ output และ pep-8
```
