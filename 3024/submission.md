...
```text
โจทย์ให้หาว่าคะแนนรวมของทั้งสามคน ถ้าคนที่มากที่สุดห่างจากคนที่น้อยที่สุดมากกว่า 2 คะแนน จะทำให้คนประหลาดใจ ถ้าไม่ก็ปกติ

Input:
รับค่าคะแนนรวม3คน
รับค่าคะแนนคนที่ได้มากที่สุด

Output:
ถ้าคนที่มากที่สุดห่างจากคนที่น้อยที่สุดมากกว่า 2 คะแนน ให้พิมพ์ "Surprising" ถ้าไม้ให้พิมพ์ "Not surprising"
```
...
```text
1:สร้างตัวแปรรับค่าจำนวนจริง ของคะแนนรวม3 "SUMSCORE"
2.สร้างตัวแปรรับค่าจำนวนจริง ของคะแนนที่ได้มากที่สุด "MAX"
3.สร้างตัวแปรหาค่าคะแนนที่เหลือ "MID" = SUMSCORE - MAX
4.สร้างตัวแปรหาค่าต่ำสุดที่สูงที่สุดเท่าที่เป็นไปได้ "MIN" = MID - MAX
5.ถ้า MAX - MIN > 2 ให้พิมพ์ "Surprising"
6.ถ้าไม่ ให้พิมพ์ "Not surprising"
```
...
```text
วิธีสุดท้ายคล้ายกับแผนแรก แต่ลัดการหาค่าต่ำสุด และ เพิ่มให้ คะแนนต่ำสุดถ้าต่ำกว่า 0 คือ 0 จะได้ไม่ต้องมาคำนวนเลขติดลบ

1:สร้างตัวแปรรับค่าจำนวนจริง ของคะแนนรวม3 "SUMSCORE"
2.สร้างตัวแปรรับค่าจำนวนจริง ของคะแนนที่ได้มากที่สุด "MAX"
3.สร้างตัวแปรหาค่าคะแนนต่ำสุด "SCOREMIN" = SUMSCORE - MAX*2
4.ถ้า SCOREMIN < 0 ให้ SCOREMIN = 0
5.ถ้า MAX - MIN > 2 ให้พิมพ์ "Surprising"
6.ถ้าไม่ ให้พิมพ์ "Not surprising"
```
...
```text
คะแนนรวมไม่ควรต่ำกว่าคะแนนสูงสุด
```
