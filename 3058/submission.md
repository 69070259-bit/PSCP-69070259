...
```text
โจทย์ให้ผมรับค่าอิฐเล็กกับอิฐใหญ่ แล้วหาว่าต้องใช้อิฐเล็กกี่อันถึงจะต่อได้ตามที่ต้องการ

input:
รับค่า brickA และ brickB และ goal
...
step2:รับค่า = BRICKB 
step3:รับค่า = GOAL
step4:ให้ B = BRICKB * 5
step5:ถ้า GOAL <= 0 ให้พิมพ์ 0
step6:ถ้า BRICKA + B < GOAL ให้พิมพ์ -1
step7:ถ้า B >= GOAL และ GOAL % 5 = 0 ให้พิมพ์ 0
step8:ถ้า GOAL % 5 และ ถ้า BRICKA < GOAL % 5 ให้พิมพ์ -1
   และถ้า BRICKA >= GOAL % 5 ให้พิมพ์(GOAL % 5)
step9:ถ้า BRICKA >= GOAL และถ้า BRICKB <= 0 ให้พิมพ์(BRICKA - (BRICKA-GOAL))
   และถ้า BRICKB > 0 ให้พิมพ์(BRICKA - (BRICKA - (GOAL - B)))
step10:ถ้า BRICKA + B == GOAL ให้พิมพ์ 0
```
...
```text
เพิ่ม BRICKA >= GOAL % 5 and B < GOAL ให้พิมพ์BRICKA - (BRICKA - (GOAL - B))
...
step7:ถ้า B >= GOAL และ GOAL % 5 = 0 ให้พิมพ์ 0
step8:ถ้า GOAL % 5 และ ถ้า BRICKA < GOAL % 5 ให้พิมพ์ -1
   และถ้า BRICKA >= GOAL % 5 and B < GOAL ให้พิมพ์BRICKA - (BRICKA - (GOAL - B))
   และถ้า BRICKA >= GOAL % 5 ให้พิมพ์(GOAL % 5)
step9:ถ้า BRICKA >= GOAL และถ้า BRICKB <= 0 ให้พิมพ์(BRICKA - (BRICKA-GOAL))
   และถ้า BRICKB > 0 ให้พิมพ์(BRICKA - (BRICKA - (GOAL - B)))
step10:ถ้า BRICKA + B == GOAL ให้พิมพ์ 0
