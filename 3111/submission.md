...
```text
โจทย์ให้ใส่ว่าเป็นสมาชิกหรือไม่ จำนวนที่ต้องการซื้อ และ ราคา จำนวนตามที่ต้องการซื้อ และให้พิมพ์ค่ามี่คำนวณออกมาได้
input:
สถานะสมาชิก
จำนวนซื้อ
ราคา ตามจำนวนซื้อ
...
```text
step1:นำเข้าdecimal
step2:สร้างตัวแปรรับค่า member
step3: สร้างตัวแปรรับค่า buy
step4: สร้างตัวแปร item เปล่า
step5:สร้างlistเปล่า listy
step6:ตามจำนวน buy ให้ รับค่าราคา และใส่ใน listy
step7:preprice = ผลรวมของ listy
step8:y = preprice - (preprice / 100) * 5
step9:n = preprice - (preprice / 100) * 3
step10:ให้ halfroundup y
step11:ให้ halfroundup n
step12:ถ้า member = y ให้พิมพ์ y
step13:ถ้า member = n และถ้า preprice >= 500 ให้ พิมพ์ n
step14:ถ้าไม่ให้พิมพ์ preprice
```
...
```text
step1:สร้างตัวแปรรับค่า member
step2: สร้างตัวแปรรับค่า buy
step3: สร้างตัวแปร item เปล่า
step4:สร้างlistเปล่า listy
step5:ตามจำนวน buy ให้ รับค่าราคา และใส่ใน listy
step6:preprice = ผลรวมของ listy
step7:y = preprice - (preprice / 100) * 5
step8:n = preprice - (preprice / 100) * 3
step9:ถ้า member = y ให้พิมพ์ y ปัดเศษทศนิยม 2 หลัก
step10:ถ้า member = n และถ้า preprice >= 500 ให้ พิมพ์ n ปัดเศษทศนิยม 2 หลัก
step11:ถ้าไม่ให้พิมพ์ preprice ปัดเศษทศนิยม 2 หลัก
```
