...
```text
โจทย์ให้นำสีทั้งสองสีมาผสมกันแล้วให้บอกสีที่ผสมได้

input:
รับค่าstringค่า "Color1"
รับค่าstringค่า "Color2"

output:
ถ้าหาก Color1 ตรงกับ สีสีหนึ่ง และ Color2 ตรงกับ สีสีหนึ่ง
ให้พิมพ์สีที่ผสมได้
```
...
```text
Step1:รับค่าstingให้ตัวแปร "Color1"
Step2:รับค่าstingให้ตัวแปร "Color2"
Step3:ถ้า Color1 == "Red" และ Color2 == "Yellow" หรือ  Color1 == "Yellow" และ Color2 == "Red"
Step4:พิมพ์ "Orange"
Step5:ถ้า Color1 == "Red" และ Color2 == "Blue" หรือ  Color1 == "Blue" และ Color2 == "Red"
Step6:พิมพ์ "Purple"
Step7:ถ้า Color1 == "Yellow" และ Color2 == "Blue" หรือ  Color1 == "Blue" และ Color2 == "Yellow"
Step8:พิมพ์ "Green"
Step9:ที่เหลือ
Step10:พิมพ์ "Error"
```
...
```text
วิธีสุดท้ายเปลี่ยน "Purple" เป็น "Violet" เพราะลืมอ่าน input
และเพิ่มการใส่สีซ้ำเพื่อให้ผ่านครบทุก testcase
...
Step7:ถ้า Color1 == "Yellow" และ Color2 == "Blue" หรือ  Color1 == "Blue" และ Color2 == "Yellow"
Step8:พิมพ์ "Green"
Step9:ถ้า Color1 == "Red" และ Color2 == "Red" หรือ  Color1 == "Red" และ Color2 == "Red"
Step10:พิมพ์ "Red"
Step11:ถ้า Color1 == "Yellow" และ Color2 == "Yellow" หรือ  Color1 == "Yellow" และ Color2 == "Yellow"
Step12:พิมพ์ "Yellow"
Step13:ถ้า Color1 == "Blue" และ Color2 == "Blue" หรือ  Color1 == "Blue" และ Color2 == "Blue"
Step14:พิมพ์ "Blue"
Step15:ที่เหลือ
Step16:พิมพ์ "Error"
```
...
```text
เพื่อนจาก sec เดียวกัน
```

เขาช่วยอะไร

```text
ช่วยบอกว่าควรทำอย่างไรให้ผ่านทุก testcase
```
