...
```text
โจทย์ให้ใส่ข้อความ 5 บรรทัด และ ใส่กรอบด้วย *

input:
รับstring 5 ครั้ง

output:
เขียน * ล้อมรอบข้อความ
```
...
```text
step1: สร้างตัวแปร text เพื่อให้ไม่ติด pep-8
step2: สร้าง list "listy"
step3: สร้าง list "listylen"
step4: สร้างตัวแปร lenty เพื่อให้ไม่ติด pep-8
step5: สร้าง for loop 5 ครั้ง ให้ "text" รับ input และนับจำนวนตัวอักษร และ นำใส่ list
step6: ตัวแปร frame = listylen ที่มากที่สุด * "*"
step7: พิมพ์ f"*{frame}*"
step8: สร้าง for loop 5 ครั้ง และพิมพ์ f"*{listy[จำนวน loop]}{" " * (int(max(listylen)) - int(listylen[จำนวน loop]))}*"
step9: พิมพ์ f"*{frame}*"
```
...
```text
วิธีสุดท้ายคล้ายกับของวิธีแรก แต่เพิ่ม * อีก 2 ตัว
```
