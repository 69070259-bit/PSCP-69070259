...
```text
โจทย์ให้ใส่stingและนับสระจากstringที่มี และพิมพ์จำนวนลง
input:
รับค่าstingแบบพิมพ์เล็ก

สร้างตัวแปร รับ จำนวนตัวสระ ให้ครบ

output:
ถ้าสระมากกว่า0ให้พิมพ์ ทำไปเลื่อยๆให้ครบ
```
...
```text
step1: สร้างตัวแปรรับค่าsting "text"
step2: สร้างตัวแปรรับค่า นับค่า(count()) สระที่กำหนดจาก "text"
step3: ทำไปเลื่อยๆให้ครบ aeiou
step4: ใช้ if ถ้า"จำนวนสระ" > 0 ให้พิมพ์fstring "สระ" : "จำนวน"
step5: ทำไปเลื่อยๆให้ครบ aeiou
```
...
```text
คล้ายกับวิธีแรก แต่รับค่า"text"แล้วแปรงเป็นlower.
```
