...
```text
โจทย์ให้รับชื่อเส้นทาง และให้หาราคาและบวกค่าธรรมเนียม
input:
รับเส้นทาง
รับค่าน้ำหนัก

output:
พิมพ์น้ำหนักคูณค่าและบวกค่าธรรมเนียมตามเส้นทางนั้น
```
...
```text
step1:สร้างตัวแปรรับค่า ROUTE
step2:สร้างตัวแปรรับค่า WEIGHT
step3:ถ้า ROUTE 1 == "ต้นทาง" และ ROUTE2 == "ปลายทาง"
step4:พิมพ์ค่าน้ำหนักคูณกับค่าเส้นทางและค่าธรรมเนียม
step5:ทำไปเลื่อยจนกว่าจะครบ
...
```text
เหมือนกับอันแรกแค่แก้ข้อผิดพลาด
