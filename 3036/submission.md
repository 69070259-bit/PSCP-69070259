...
```text
โจทย์ให้นำค่าห้องมาใส่แล้วให้หาว่าต้องไปห้องที่1ยังไงให้ทำลายกำแพงให้น้อยสุด
input:
รับค่า ROOM

output:
ใช้ while loop เพื่อหาชั้น
จำนวนกำแพง = ชั้น-1 * 2 เท่ากับจำนวนกำแพง
ถ้าชั้นและห้องเป็นเลขคู่ ให้พิมพ์จำนวนกำแพงเลย
ถ้าชั้นและห้องเป็นเลขคี่ ให้พิมพ์จำนวนกำแพงเลย
ถ้าชั้นและห้องเป็นเลขคู่และเลขคี่ ให้พิมพ์จำนวนกำแพง - 1
```
...
```text
Step 1:รับค่า ROOM
Step 2:ถ้า ROOM == (เลขห้องใดๆ) ให้พิมพ์เลขกำแพงนั้นๆ
```
...
Step 1:รับค่า ROOM
Step 2:FLOOR = 1
Step 3:หาก ROOM > FLOOR**2 ให้ FLOOR += 1
Step 4:WALL = (FLOOR-1)*2
Step 5:WALLNOTNORMAL = WALL - 1
Step 6:ถ้าชั้นและห้องเป็นเลขคู่ ให้พิมพ์ WALL
Step 7:ถ้าชั้นและห้องเป็นเลขคี่ ให้พิมพ์ WALL
Step 8:ถ้าชั้นเป็นเลขคี่และห้องเป็นเลขคู่ ให้พิมพ์ WALLNOTNORMAL
Step 9:ถ้าชั้นเป็นเลขคู่และห้องเป็นเลขคี่ ให้พิมพ์ WALLNOTNORMAL
```
