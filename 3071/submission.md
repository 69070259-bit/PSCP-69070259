...
```text
โจทย์ให้หาว่าระหว่างตัวเลขทั้งสองจะหารและได้เศษที่กำหนดกี่ตัว
input:
สร้างตัวแปรรับค่าเลขชุด1
สร้างตัวแปรรับค่าเลขชุด2
สร้างตัวแปรรับค่าเลขหาร
สร้างตัวแปรรับค่าเลขเศษ
output:
ให้นำตัวเลขมาหารเอาเศษที่กำหนดตามจำนวนเลขชุด1 และ ชุด2
จากนั้นนำเศษที่กำหนดมาใส่list และ นับ
```
...
```text
step1: สร้างตัวแปรรับค่า "A"(เลขชุด1)
step2: สร้างตัวแปรรับค่า "B"(เลขชุด2)
step3: สร้างตัวแปรรับค่า "D"(เลขหาร)
step4: สร้างตัวแปรรับค่า "R"(เศษที่ต้องการ)
step5:สร้างตัวแปรเก็บ list ว่าง A
step5:สร้างตัวแปรเก็บ list ว่าง B
step6:ใช้ for loop เพื่อแยกเลขชุด1เก็บใน list a
step7:ใช้ for loop เพื่อแยกเลขชุด2เก็บใน list b
step8:สร้างตัวแปร listลบ และเก็บค่า list a - list b
step9:นำ listลบ มา modulo
step10:จากนั้นก็นับเลขเศษที่ต้องการแล้วก็พิมพ์
```
...
step3: สร้างตัวแปรรับค่า "D"(เลขหาร)
step4: สร้างตัวแปรรับค่า "R"(เศษที่ต้องการ)
step5:สร้างตัวแปรเก็บ list ว่าง
step6:for i loop ใน ระยะเลขชุด1 ละ เลขชุด2
step7:ให้ i modulo D == R
step8:นำ i ใส่ list
step9: พิมพ์ list ที่นับแล้ว
```
...
```text
ช่วยบอกว่าสามารถนำจำนวนนับA และ จำนวนนับB ใส่ในระยะของ for loop และจะได้ไม่ต้องเอาไปลบให้ยุ่งยากเหมือนวิธีแรก
```
