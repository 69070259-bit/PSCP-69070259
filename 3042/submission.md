...
```text
Input:
สร้างตัวแปรให้รับค่าint "Num"
สร้างตัวแปรเก็บค่า 0 "Sib"
สร้างlistเอาไว้ใส่ค่าทั้งหมดเพื่อที่จะได้นำไปแสดงผลให้ย้อนกลับ "Listy"

Output:
ในขณะที่ "Sib" น้อยกว่าเท่ากับ "Num"
ให้บวก 10 ใส่ Sib ไปเลื่อยๆจนกว่าจะมากกว่า Num แล้วหยุด
แต่ให้นำค่าใส่ Listy ก่อนที่จะหยุด
จากนั้นก็ให้ Listy มี list สลับ
และพิมพ์ออกมาแบบที่ไม่มี []
```
...
```text
Step1:สร้างตัวแปร "Num" เพื่อเก็บค่าint
Step2:สร้างตัวแปร "Sib" เก็บค่า 0
Step3:สร้างlist "Listy"
Step4:ในขณะที่ "Sib" <= "Num" ให้นำไปใส่ใน Listy และ นำ Sib + 10 ไปเลื่อยๆ
Step5:ถ้า "Sib" > "Num" ให้หยุด
Step6:กลับ list "Listy"
Step7:พิมพ์ Listy
```
...
```text
วิธีสุดท้ายเหมือนกับวิธีแรก แต่จะพิมพ์ *Listy เพื่อให้ไม่มี [] ขึ้น
```
...
```text
ช่วยสอนการ list reverse
```

คุณยังทำอะไรด้วยตนเอง

```text
code เกือบทั้งหมด ยกเว้นการ สร้าง list เพื่อตอบค่าจากหลังไปหนา, debug ต่างๆ, test code
```
