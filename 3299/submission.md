...
```text
โจทย์รับค่า แถว และ จำนวนดอกไม้ และ ให้หาว่าดอกไม้ดอกอันสุดท้าย จะตกอยู่ในแถบไหน
```
...
```text
step1: สร้างตัวแปรรับค่า string "text" และแยกออก
step2: line = จำนวนนับ(text[0])
step3: num = จำนวนนับ(text[1])
step4: สร้างตัวแปร numbre = 0
step5: ในขณะที่ ((numbre * line) * (numbre * line + 1) // 2) < num ให้ numbre += 1
step6: พิมพ์ numbre
...
```text
วิธีสุดท้างเหมือนกับวิธีแรกแค่แก้ pep-8
```
