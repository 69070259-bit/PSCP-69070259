...
```text
โจทย์ให้รับค่าการขยายตัวและจำนวนบ้าน และให้หาว่าบ้านแต่ละหลังจะโดนหมึกท่วมในเวลาเท่าได

input:
การขยายตัวและจำนวนบ้าน
ใส่ตำแหน่งบ้านตามจำนวนบ้าน
...
Step 1: Import math
Step 2: รับค่า INKY
Step 3: แยก INKY เป็น EXPANSION กับ ROLL
Step 4: DURATION = 0
Step 5: สร้าง list เปล่า LISTY
Step 6: หาก ROLL > 0
Step 7: รับค่า LISTYLOCATION
Step 8: แยก LISTYLOCATION เป็น X กับ Y
Step 9: นำ X กับ Y ใส่ LISTY
Step 10: ROLL -= 1
Step 11: สำหรับ LISTY ใน LISTY
Step 12: DISTANCE = (LISTY(ค่าแรก) ** 2 ) + (LISTY(ค่าสอง) ** 2)
Step 13: DURATION += (ปัดขึ้น (DISTANCE/EXPANSION) * 3.14) - DURATION
Step 14: พิมพ์ DURATION
```
...
```text
คล้ายกับขั้นตอนแรกแต่ 3.14 เป็น 3.1416
...
Step 11: สำหรับ LISTY ใน LISTY
Step 12: DISTANCE = (LISTY(ค่าแรก) ** 2 ) + (LISTY(ค่าสอง) ** 2)
Step 13: DURATION += (ปัดขึ้น (DISTANCE/EXPANSION) * 3.1416) - DURATION
Step 14: พิมพ์ DURATION
```
